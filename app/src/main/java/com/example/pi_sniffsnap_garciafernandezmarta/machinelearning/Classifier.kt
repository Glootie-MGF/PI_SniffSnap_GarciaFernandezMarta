...
import com.example.pi_sniffsnap_garciafernandezmarta.MAX_RECOGNITION_DOG_RESULTS
...
class Classifier (tfLiteModel: MappedByteBuffer, private val labels: List<String>) {
    ...
    init {
        ...
        // Todas las imágenes con las que entrenamos el modelo fueron 224 x 224
        // El 3 representa que son RGB
